...
var height = 400;
var barPadding = 10;
// set the width and height on the svg and store in a variable
var svg = d3
  .select("svg")
  .attr("width", width)
  .attr("height", height);
...
d3.select("form").on("submit", function() {
  ...
  // store result of get frequences in a variable
  var data = getFrequencies(text);
  //use the var to  calculate the bar width and padding
